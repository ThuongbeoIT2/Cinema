...
public class MovieService implements IMovieService{
    ...
    public List<MovieDTO> findAllShowingMovies() {
        ...
        // biến danh sách đối tượng movie thành luồng stream. sau đó chuyển đổi đối tượng movie thành đối tượng moviedto thông qua modelMapper . rồi nhóm lại thu về danh sách dto. hay vl
    }

    @Override
    public MovieDTO getById(Integer movieId) {
        return modelMapper.map(movieRepository.getById(movieId),MovieDTO.class);
        // biến đối tượng movie tìm được thành movie dto
    }
